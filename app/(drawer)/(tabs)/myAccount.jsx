...
export default function MyAccount() {
    ...
    const defaultUserData = {
        ...
        lastname:existingUser && existingUser.userData.lastname || "Teacher",
        email:existingUser && existingUser.userData.email || "demoteacher@gmail.com",
        phone:existingUser && existingUser.userData.phone || "1234567890",
        passion: "",
        profession:existingUser && existingUser.usertype || "Teacher",
    };
