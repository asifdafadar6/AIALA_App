...
import { View, Text, Button, TextInput, FlatList, TouchableOpacity, Modal, ScrollView, ActivityIndicator } from 'react-native';
import { MyContext } from '../../components/provider/contextApi';
import { student_assessment_report, submitAnswers } from '../../components/provider/students_api';
...
export default function MockExam() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await submitAnswers(assessmentId, "username", userResponses);
            if (response) {
